...
conn = psycopg2.connect(database="flask_db", user="postgres",
						password="root", host="192.168.7.5", port="5432")
...
def delete():
	conn = psycopg2.connect(database="flask_db", user="postgres", password="root", host="192.168.7.5", port="5432")
	cur = conn.cursor()
...
if __name__ == '__main__':
	app.run(debug=True, host='192.168.6.5')
